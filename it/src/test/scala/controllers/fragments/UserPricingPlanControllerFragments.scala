...
object UserPricingPlanControllerFragments {
  ...
  val resetUserPricingPlanTables: fragment.Fragment =
  ...
  val seedUserPlans: fragment.Fragment =
    sql"""
      ...
      VALUES
        ('USER001', 'PLAN002', NULL, 'cus_u1', 'Active', '2025-02-01 00:00:00', NULL, false),
        ('USER002', 'PLAN006', NULL, 'cus_u2', 'Active', '2025-02-02 00:00:00', NULL, false),
        -- two different users share a customer id to test ORDER BY started_at
        ('USER003', 'PLAN001', NULL, 'cus_dup', 'Active', '2025-01-01 00:00:00', NULL, false),
        ('USER004', 'PLAN003', NULL, 'cus_dup', 'Active', '2025-03-01 00:00:00', NULL, false);
    """
}
