  ...
  val insertQuestData: fragment.Fragment =
    sql"""
        INSERT INTO quests (
          ...
          ('USER007', 'QUEST010', 'DEV006', 'Demon', 'Some Quest Title 1', 'Some Quest Description 1', 'Some acceptance criteria', 'InProgress', '{Python, Scala, Typescript}', true, '2025-01-01 00:00:00', '2025-01-02 12:00:00'),
          ('USER007', 'QUEST011', 'DEV007', 'Demon', 'Some Quest Title 2', 'Some Quest Description 2', 'Some acceptance criteria', 'InProgress', '{Python, Scala, Typescript}', true, '2025-01-01 00:00:00', '2025-01-02 12:00:00'),
          ('USER007', 'QUEST012', 'DEV008', 'Demon', 'Some Quest Title 3', 'Some Quest Description 3', 'Some acceptance criteria', 'Completed', '{Python, Scala, Typescript}', true, '2025-01-01 00:00:00', '2025-01-02 12:00:00'),
          ('USER007', 'QUEST013', 'DEV009', 'Demon', 'Some Quest Title 4', 'Some Quest Description 4', 'Some acceptance criteria', 'Completed', '{Python, Scala, Typescript}', true, '2025-01-01 00:00:00', '2025-01-02 12:00:00'),
          ('USER007', 'QUEST014', 'DEV010', 'Demon', 'Some Quest Title 5', 'Some Quest Description 5', 'Some acceptance criteria', 'NotStarted', '{Python, Scala, Typescript}', true, '2025-01-01 00:00:00', '2025-01-02 12:00:00'),
          ('USER007', 'QUEST015', 'DEV011', 'Demon', 'Some Quest Title 6', 'Some Quest Description 6', 'Some acceptance criteria', 'NotStarted', '{Python, Scala, Typescript}', true, '2025-01-01 00:00:00', '2025-01-02 12:00:00');
      """
  ...
  val insertQuestDataNoDevId: fragment.Fragment =
    sql"""
        INSERT INTO quests (
          ...
          ('USER001', 'QUEST016', 'Demon', 'Implement User Authentication', 'Set up Auth0 integration and secure routes using JWT tokens.', 'Some acceptance criteria', 'InProgress', '{Python, Scala, Typescript}', true, '2025-01-01 00:00:00', '2025-01-02 12:00:00');
      """
}
